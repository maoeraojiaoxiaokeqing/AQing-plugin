...
const _cfgPath = `${_path}/plugins/Xs-plugin/components/`
let cfg = {}

let configPath = `${_path}/plugins/Xs-plugin/config/config/`
let defSetPath = './plugins/Xs-plugin/config/defSet_config/'
